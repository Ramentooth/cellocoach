...
- **Live chromatic tuner** — starts with every practice session and shows the nearest note, frequency, cents sharp or flat, and a responsive tuning needle. When a note stops, its reading stays up for two seconds so you can see whether it was flat or sharp. You can stop or restart it at any time.
- **Metronome** — sits under the tuner and comes up with every session. The click is loud and bright so it carries over the cello, with a higher click on the downbeat; the tuner ignores the clicks it hears through the mic.
